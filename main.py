...
# Exit Button
    ...
    # Author credit
    tk.Label(home, text="Created by:",
             font=("Segoe UI", 14), fg="#aaaaaa", bg="#1e1e1e").pack(pady=20)
 ...
 # Authors Section
    ...
    def add_author(frame, image_file, name, usn):
        from PIL import Image, ImageTk
        img = Image.open(image_file)
        img = img.resize((80, 80))  # Resize image to fit nicely
    ...
    add_author(author1, "chethana.png", "Chethana R", "1SJ21CS029")

    author2 = tk.Frame(authors_frame, bg="#1e1e1e")
    author2.pack(side="left", padx=40)
    add_author(author2, "chandana.png", "Chandana L U", "1SJ21CS026")

    author3 = tk.Frame(authors_frame, bg="#1e1e1e")
    author3.pack(side="left", padx=40)
    add_author(author3, "bhavana.png", "Bhavana G S", "1SJ21CS023")
